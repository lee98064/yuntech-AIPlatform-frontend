...
.timeline-centered
  .timeline-entry
  .timeline-entry-inner
  .timeline-label.bg-light1 {
  background: #33b133;
}
.timeline-centered
  .timeline-entry
  .timeline-entry-inner
  .timeline-label.bg-light1:after {
  border-color: transparent #33b133 transparent transparent;
}
.timeline-centered
  .timeline-entry
  .timeline-entry-inner
